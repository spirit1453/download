...
cmd=$javapath
params="-Xmx2500m  -Dosgi.console.blockOnReady=true -Dcom.jiuqi.dna.ui.theme=sky -DvncServer= -DconsoleServer= -DrmServer= -Dcustomer=QS   -Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=5001"
